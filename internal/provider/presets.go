...
var presets = []PresetDef{
	...
	{ID: "requesty", Name: "Requesty", Icon: "requesty-color", Kind: KindRelay, Catalog: "requesty",
		Chat: "https://router.requesty.ai/v1", Anthropic: "https://router.requesty.ai",
		Website: "https://www.requesty.ai", KeysURL: "https://app.requesty.ai/api-keys",
		Regions: []Region{
			{ID: "global", Name: "Global", Chat: "https://router.requesty.ai/v1", Anthropic: "https://router.requesty.ai"},
			{ID: "eu", Name: "EU", Chat: "https://router.eu.requesty.ai/v1", Anthropic: "https://router.eu.requesty.ai"},
			{ID: "us", Name: "US", Chat: "https://router.us.requesty.ai/v1", Anthropic: "https://router.us.requesty.ai"},
			{ID: "ap", Name: "Asia Pacific", Chat: "https://router.ap.requesty.ai/v1", Anthropic: "https://router.ap.requesty.ai"},
		}},
